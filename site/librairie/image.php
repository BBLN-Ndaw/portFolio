...
* resize d'une image
*/
function resisedName($file, $width, $height)
{
    $info=pathinfo($file);
    $return ='';
...
/**
* fonction pour redimensionner une image (augmente ou diminue la taille de l'image) : *
 le lien : https://github.com/cargan/CakePHP-ImageHelper/blob/master/View/Helper/ImageHelper.php
*/
function resizeImage($file, $width, $height){
	/* ça prend le nom du fichier et redimensionne puis rajoute l'extension .png*/
        ...
        if (!file_exists($output)) {
            ...
            switch ( $info[2] ) {
              case IMAGETYPE_GIF:   imagegif($image_resized,  $output, 80);    break;//80 c'est la qualité de l'image
